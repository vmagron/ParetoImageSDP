...
f1 = 1/25 * (16 * x(1)^3 + 9 * x(1) * x(2)^2) ;
f2 = 1/25 * (8 * x(2)^3 + 9 * x(1)^2 * x(2)); 
...
for k = 1:N
 ...
 xp = [xp1; xp2];
 xp = -1 + 2 * xp;
 f1p = 1/25 * (16 * xp(1)^3 + 9 * xp(1) * xp(2)^2) ;
 f2p = 1/ 25 * (8 * xp(2)^3 + 9 * xp(1)^2 * xp(2));
...
cd measureimage;
[y1, y2, wk4]= measureimage(x, y, [f1; f2], 4, g, lo, up, 0, 0);
[y1, y2, wk6]= measureimage(x, y, [f1; f2], 6, g, lo, up, 0, 0);
[y1, y2, wk8]= measureimage(x, y, [f1; f2], 8, g, lo, up, 0, 0);
