...
[y1, y2, Jk2]= exists(x, z, f1, f2, 2, 2, g, m1, M1, m2, M2, 0);
[y1, y2, Jk3]= exists(x, z, f1, f2, 3, 3, g, m1, M1, m2, M2, 0);
...
xlabel('\ity_1', 'Interpreter','tex'); ylabel('\ity_2', 'Interpreter','tex'); print -depsc '../figs/lax/lax_exists2.eps';


hparetocheb = figure('visible','off'); set(0,'DefaultAxesFontName', 'Palatino');set(0,'DefaultAxesFontSize', 20);
set(0,'DefaultTextFontname', 'Palatino');set(0,'DefaultTextFontSize', 20);
contourf(y1,y2, -Jk3,[0 0],'y'); hold on; plot(X,Y,'.k'); 
xlabel('\ity_1', 'Interpreter','tex'); ylabel('\ity_2', 'Interpreter','tex'); print -depsc '../figs/lax/lax_exists3.eps';
